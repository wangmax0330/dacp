...
@WebServlet(name = "ComplexVerificationCodeServlet", urlPatterns = {"/ComplexVerificationCodeServlet"})
public class ComplexVerificationCodeServlet extends HttpServlet {

...
public class RemoteExecuteCommand {
    ...
    public static void main(String[] args) {
        RemoteExecuteCommand rec=new RemoteExecuteCommand("192.168.1.31", "root","root@123");
        //执行命令
//        System.out.println(rec.execute("ifconfig"));
        //执行脚本
        System.out.println (rec.execute(" tail -f /opt/web/shj/tomcat.xsimple/logs/catalina.out "));

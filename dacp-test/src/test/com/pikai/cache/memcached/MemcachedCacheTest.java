...
public class MemcachedCacheTest {
	...
	public void test1() throws IOException {
		MemcachedClientBuilder builder = new XMemcachedClientBuilder(AddrUtil.getAddresses("121.42.212.240:11211"));
		 ...
		 * thread and some thread pools, if you create too man      clients,the cost
	...
	@Test
	public void test2() throws TimeoutException, InterruptedException, MemcachedException, IOException {
		MemcachedClientBuilder builder = new XMemcachedClientBuilder(AddrUtil.getAddresses("121.42.212.240:11211"));
		MemcachedClient client = builder.build();
		client.flushAll();
	...
	@Test
	public void incrDecr() throws IOException, TimeoutException, InterruptedException, MemcachedException {
		MemcachedClientBuilder builder = new XMemcachedClientBuilder(AddrUtil.getAddresses("121.42.212.240:11211"));
		MemcachedClient client = builder.build();
		/**
	...
	public void auth() throws Exception {
		MemcachedClientBuilder builder = new XMemcachedClientBuilder(AddrUtil.getAddresses("121.42.212.240:11211"));
		builder.addAuthInfo(AddrUtil.getOneAddress("121.42.212.240:11211"), AuthInfo.typical("cacheuser", "123456"));
	...
	public void testGet() throws IOException, TimeoutException, InterruptedException, MemcachedException {
		MemcachedClientBuilder builder = new XMemcachedClientBuilder(AddrUtil.getAddresses("121.42.212.240:11212"));
		MemcachedClient client = builder.build();
	...
	public void testGet2() throws IOException, TimeoutException, InterruptedException, MemcachedException {
		MemcachedClientBuilder builder = new XMemcachedClientBuilder(AddrUtil.getAddresses("121.42.212.240:11212"));
		MemcachedClient client = builder.build();
		String value = client.get("srp_" + "3rdsearch_周杰伦");
